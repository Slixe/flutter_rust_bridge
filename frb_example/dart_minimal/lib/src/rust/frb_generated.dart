...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -256087924;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<BigInt> crateApiTimeNativeHelloWorld();
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<BigInt> crateApiTimeNativeHelloWorld() {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        return wire.wire__crate__api__time__native__hello_world(port_);
      },
      codec: DcoCodec(
        decodeSuccessData: dco_decode_u_64,
        decodeErrorData: null,
      ),
      constMeta: kCrateApiTimeNativeHelloWorldConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiTimeNativeHelloWorldConstMeta =>
      const TaskConstMeta(
