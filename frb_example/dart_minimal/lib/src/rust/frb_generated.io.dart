...
class RustLibWire implements BaseWire {
  ...
  void wire__crate__api__time__native__hello_world(
    int port_,
  ) {
    return _wire__crate__api__time__native__hello_world(
      port_,
    );
  }

  late final _wire__crate__api__time__native__hello_worldPtr = _lookup<
          ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
      'frbgen_frb_example_dart_minimal_wire__crate__api__time__native__hello_world');
  late final _wire__crate__api__time__native__hello_world =
      _wire__crate__api__time__native__hello_worldPtr
