...
void frbgen_frb_example_dart_minimal_wire__crate__api__time__native__hello_world(int64_t port_);
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_frb_example_dart_minimal_wire__crate__api__time__native__hello_world);
